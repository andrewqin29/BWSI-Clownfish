...
bool Underwater::OnNewMail(MOOSMSG_LIST &NewMail)
{
...
bool Underwater::OnConnectToServer()
{
   RegisterVariables();
   return(true);
}
...
void Underwater::RegisterVariables()
{
  //--------------------------
  // BWSI added code
  Register("NAV_X", 0);
